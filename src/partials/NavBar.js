            ...
            <div className="navbar-custom-menu">
              <ul className="nav navbar-nav">
                      ...
                      <ul className="menu">
                        <li>
                          <a href="#">
                            ...
                            <div className="progress xs">
                              <div className="progress-bar progress-bar-aqua twentyPercent"  role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                        ...
                        <li>
                          <a href="#">
                            ...
                            <div className="progress xs">
                              <div className="progress-bar progress-bar-green fourtyPercent" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                ...
                <li className="dropdown user user-menu">
                  <a href="#" className="dropdown-toggle" data-toggle="dropdown">
                    <img src="../img/avatar.png" className="user-image" alt="..." />
